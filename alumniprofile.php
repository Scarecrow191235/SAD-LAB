...
<div class="bs-example" data-example-id="simple-horizontal-form">
       <form class="form-horizontal" method="post" >
		...
		<label for="inputEmail3" class="col-sm-2 control-label">&nbsp;</label>
		 <label for="inputEmail3" class="col-sm-2 control-label">&nbsp;</label>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="upload/alumni/<?php echo $photo; /* DEVELOPED BY WWW.STUDENTPROJECTS.LIVE */  ?>" height="120px" width="120px" readonly />
		</div>
	   <div class="form-group">
	    <label for="inputEmail3" class="col-sm-2 control-label">&nbsp;</label>
      ...
      <div class="form-group">
	   <label for="inputEmail3" class="col-sm-2 control-label">&nbsp;</label>
        ...
        <div class="col-sm-6">
          <input type="text" class="form-control" id="Name" name="Name" placeholder="Name" required value="<?php echo $name; /* DEVELOPED BY WWW.STUDENTPROJECTS.LIVE */  ?>"readonly>
        </div>
      </div> 
	    <div class="form-group">
		 <label for="inputEmail3" class="col-sm-2 control-label">&nbsp;</label>
        <label for="inputEmail3" class="col-sm-2 control-label">Gender</label value="<?php echo $gender; /* DEVELOPED BY WWW.STUDENTPROJECTS.LIVE */  ?>">
        <div class="col-sm-6">
        ...
        <div class="col-sm-6">
          <input type="date" class="form-control" id="Date_Of_Birth" name="Date_Of_Birth" placeholder="Date of Birth" value="<?php echo $dob; /* DEVELOPED BY WWW.STUDENTPROJECTS.LIVE */  ?>" readonly >
        </div>
      </div> 
	  <div class="form-group">
	   <label for="inputEmail3" class="col-sm-2 control-label">&nbsp;</label>
        ...
        <div class="col-sm-6">
          <input type="email" class="form-control" id="Email" name="Email" placeholder="Email Id" value="<?php echo $email; /* DEVELOPED BY WWW.STUDENTPROJECTS.LIVE */  ?>" readonly >
        </div>
      </div>
	  <div class="form-group">
	   <label for="inputEmail3" class="col-sm-2 control-label">&nbsp;</label>
        ...
        <div class="col-sm-6">
          <input type="text" class="form-control" id="phone" name="phone" placeholder="Contact no."  value="<?php echo $contactno; /* DEVELOPED BY WWW.STUDENTPROJECTS.LIVE */  ?>" readonly>
        </div>
      </div>
	  <div class="form-group">
	   <label for="inputEmail3" class="col-sm-2 control-label">&nbsp;</label>
        ...
        <div class="col-sm-6">
          <input type="text" class="form-control" id="Passing_Out_year" name="Passing_Out_year" placeholder="Passout Year" readonly value="<?php echo $pyear ; /* DEVELOPED BY WWW.STUDENTPROJECTS.LIVE */  ?>">
        </div>
      </div>
      <div class="form-group">
	   <label for="inputEmail3" class="col-sm-2 control-label">&nbsp;</label>
        ...
        <div class="col-sm-6">
          <input type="text" class="form-control" id="course" name="course" placeholder="Course" value="<?php echo $course; /* DEVELOPED BY WWW.STUDENTPROJECTS.LIVE */  ?>" readonly>
        </div>
      </div> 
	    <div class="form-group">
		 <label for="inputEmail3" class="col-sm-2 control-label">&nbsp;</label>
        ...
        <div class="col-sm-6">
          <input type="text" class="form-control" id="Occupation" name="Occupation" placeholder="Occupation" required value="<?php echo$occupation ; /* DEVELOPED BY WWW.STUDENTPROJECTS.LIVE */  ?>" readonly>
        </div>
      </div> 
	    <div class="form-group">
		 <label for="inputEmail3" class="col-sm-2 control-label">&nbsp;</label>
        ...
        <div class="col-sm-6">
		<textarea class="form-control" id="Address" name="Address" placeholder="Address" rows="3" readonly ><?php echo $address; /* DEVELOPED BY WWW.STUDENTPROJECTS.LIVE */  ?></textarea> 
        </div>
      </div> 
	     <div class="form-group">
		  <label for="inputEmail3" class="col-sm-2 control-label">&nbsp;</label>
        ...
        <div class="col-sm-6">
          <input type="text" class="form-control" id="location" name="location" placeholder="City" required value="<?php echo $location; /* DEVELOPED BY WWW.STUDENTPROJECTS.LIVE */  ?>" readonly>
        </div>
      </div>
