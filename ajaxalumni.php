				   ...
				   <?php
						...
						{ /* DEVELOPED BY WWW.STUDENTPROJECTS.LIVE */  ?>
							...
							<?php
								...
								{
							?>
									<img  style="width: 150px;height:150px" src="upload/alumni/<?php echo $ks['profilepic']; /* DEVELOPED BY WWW.STUDENTPROJECTS.LIVE */  ?>" alt="" >
							...
							/* DEVELOPED BY WWW.STUDENTPROJECTS.LIVE */  ?>
									<span><?php echo $ks["name"]; /* DEVELOPED BY WWW.STUDENTPROJECTS.LIVE */  ?></span>
